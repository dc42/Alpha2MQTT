...
struct modbusRequestAndResponse
{
	...
	const char *statusMqttMessage = MODBUS_REQUEST_AND_RESPONSE_PREPROCESSING_MQTT_DESC;
	const char *displayMessage = MODBUS_REQUEST_AND_RESPONSE_PREPROCESSING_DISPLAY_DESC;
